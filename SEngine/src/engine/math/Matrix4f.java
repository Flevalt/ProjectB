...
public class Matrix4f {
    ...
    public static Matrix4f createTransformationMatrix(
    	...
    	Matrix4f.rotate((float) Math.toRadians(rx),new Vector3f(0, 1, 0), matrix);
     ...
     * @return Rotation matrix
     */
    public static void rotate(float angle, Vector3f rotation, Matrix4f matrix) {
     ...
     * @return Scaling matrix
     */
    public static void scale(Vector3f vector, Matrix4f matrix) {
     ...
     * @return Scaling matrix
     */
    public static void scale(float x, float y, float z, Matrix4f matrix) {
